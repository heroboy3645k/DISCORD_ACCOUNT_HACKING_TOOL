...
commands = [
    ...
    ("grab_emails", "It shows messages which probably have emails inside. (looking only for saved messages)"),

    ("send <server_id> <channel_id> <message>", "It sends message to given channel"),
    ("automatic_send <server_id> <channel_id> <messages> <time>",
     "It send messages automatically with chosen brake <time> (only to servers)"),
